...
namespace F_Ferias.AccessData.Data.Migrations
{
    ...
    [Migration("20250220040900_migration_Feria_local_modificar_tabla_10022025_3")]
    partial class migration_Feria_local_modificar_tabla_10022025_3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("F_Ferias.Models.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("id_entidad_federativa_pertenece")
                        .HasColumnType("integer");

                    b.Property<int?>("id_funcionario_Portal_Empleo")
                        .HasColumnType("integer");

                    b.Property<int?>("id_perfil_asignado")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("id_entidad_federativa_pertenece");

                    b.HasIndex("id_funcionario_Portal_Empleo");

                    b.HasIndex("id_perfil_asignado");
            ...
            modelBuilder.Entity("F_Ferias.Models.Models.Estatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("F_Ferias.Models.Models.ferias_empleo_local", b =>
                {
                    ...
                    b.Property<bool?>("actividad_complementaria")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool?>("evento_virtual_portal_empleo")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool?>("talleres_para_personas_buscadoras_empleo")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("F_Ferias.Models.Models.ferias_nacional", b =>
                {
                    ...
                    b.Property<Dataentidades_selection_model>("Dataentidades_selection_serialize")
                        .HasColumnType("jsonb");

                    b.Property<DateTime>("create_at")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int[]>("data_entidades_selection")
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("F_Ferias.Models.Perfiles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("F_Ferias.Models.Identity.ApplicationUser", b =>
                {
                    b.HasOne("F_Ferias.Models.Models.entidad", "id_entidad_federativa_FK")
                        .WithMany()
                        .HasForeignKey("id_entidad_federativa_pertenece");

                    b.HasOne("F_Ferias.Models.Models.C_FUNCIONARIOS_PORTALEMPLEO", "id_funcionario_portal_emplep_FK")
                        .WithMany()
                        .HasForeignKey("id_funcionario_Portal_Empleo");

                    b.HasOne("F_Ferias.Models.Perfiles", "id_perfiñ_FK")
                        .WithMany()
                        .HasForeignKey("id_perfil_asignado");

                    b.Navigation("id_entidad_federativa_FK");

                    b.Navigation("id_funcionario_portal_emplep_FK");

                    b.Navigation("id_perfiñ_FK");
                });
            ...
            modelBuilder.Entity("F_Ferias.Models.Perfiles", b =>
                {
                    ...
                    b.HasOne("F_Ferias.Models.Models.Estatus", "estatus_actual")
                        .WithMany()
                        .HasForeignKey("user_created");

                    b.Navigation("estatus_actual");
